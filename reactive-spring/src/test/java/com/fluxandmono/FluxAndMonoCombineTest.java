...
public class FluxAndMonoCombineTest {
	...
	public void combineUsingMerge() {
		...
		StepVerifier.create(mergeFlux.log()).expectSubscription().expectNext("A", "B", "C", "D", "E", "F")
				.verifyComplete();
	}
	...
	public void combineUsingZip() {
		...
		StepVerifier.create(mergeFlux.log()).expectSubscription().expectNext("AD", "BE", "CF").verifyComplete();
	}
