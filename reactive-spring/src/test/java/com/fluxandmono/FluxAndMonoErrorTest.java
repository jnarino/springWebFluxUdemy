...
class FluxAndMonoErrorTest {
	...
	public void fluxErrorHandling() {
		...
		StepVerifier.create(stringFlux.log()).expectNext("A", "B", "C").expectNext("default", "default1")
				.verifyComplete();
	...
	public void fluxErrorHandling_OnErrorReturn() {
		...
		StepVerifier.create(stringFlux.log()).expectNext("A", "B", "C").expectNext("default").verifyComplete();
